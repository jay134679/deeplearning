...
2) Download our model file from http://cims.nyu.edu/~mer567/model.net.2 into the directory this README-LeConv.txt file is in.
...
th result.lua
If you downloaded the model file to somewhere other than the current directory, use the '--model_filename' flag to specify its location.
