...
** sshing in
chmod 600 ~/Desktop/leconv/leconv.pem
ssh -i ~/Desktop/leconv/leconv.pem ubuntu@52.90.3.178

** stopping our instance
aws ec2 stop-instances --instance-ids i-1a2b3c4d
fail
that's because that's not our instance id
aws ec2 stop-instances --instance-ids i-f90f127c
fail, need to specify a region
aws ec2 stop-instances --instance-ids i-f90f127c --region us-east-1b
failed: 'NoneType' object has no attribute 'get_frozen_credentials'
charlie says replace 'us-east-1' with 'us-east-1b'
...
** do full evaluation without unlabeled data
** Write result.lua
