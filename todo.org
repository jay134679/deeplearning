...
** TODO gru max epoch 10, learning rate of 0.5

th result.lua --mode=train --max_epoch=10 --model_type=gru --lr=0.5 --exp_name=gru.10e.lr5

job number 8194559

** TODO lstm max epoch 10, learning rate of 0.5
